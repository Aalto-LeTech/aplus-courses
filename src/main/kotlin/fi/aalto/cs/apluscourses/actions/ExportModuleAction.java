...
//import fi.aalto.cs.apluscourses.notifications.IoErrorNotification;
...
//    }
//
//    Module[] availableModules = ProjectModuleSource.INSTANCE.getModules(project);
//
...
//      Notifier.Companion.notify(new IoErrorNotification(ex), project);
//    }
//  }
//
//  @FunctionalInterface
