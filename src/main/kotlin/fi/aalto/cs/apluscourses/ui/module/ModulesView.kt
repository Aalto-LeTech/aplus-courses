...
class ModulesView : SimpleToolWindowPanel(true, true) {
    ...
    private fun addModule(name: String, status: String, module: Module, index: Int, installed: Boolean) {
        val itemPanel = CustomItemPanel(name, status, module, index, installed)
