...
public class ListenerUtils {
  ...
  public static void registerListener(Task task, Project project) {
    switch (task.getAction()) {
      case "editor.open":
        OpenListener openListener = new OpenListener(task);
  ...
  private static class OpenListener implements FileEditorManagerListener {
