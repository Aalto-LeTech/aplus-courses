...
public class FilterOptionActionTest {
  ...
  public void testConstructor() {
    ...
    Option filterOption = new Option(name, icon, item -> Optional.of(true), false);
  ...
  public void testIsSelected() {
    Option filterOption = new Option("My filter", null, item -> Optional.of(true), false);
  ...
  public void testSetSelected() {
    Option filterOption = new Option("Your filter", null, item -> Optional.of(true), false);
