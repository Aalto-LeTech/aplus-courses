...
public class SubmissionViewModelTest {
  ...
  public void testValidation() {
    ...
    Exercise exercise = new Exercise(100, "Exercise", "http://localhost:1000", 0, 0, 0, true, 0.0);
  ...
  public void testSubmissionNumbers() {
    Exercise exercise = new Exercise(1, "ex", "http://localhost:2000", 0, 0, 5, true, 0.0);
  ...
  public void testGetFiles() {
    Exercise exercise = new Exercise(324, "cool", "http://localhost:1324", 0, 0, 0, true, 0.0);
  ...
  public void testDefaultGroup() {
    Exercise exercise = new Exercise(1000, "wow", "http://www.fi", 0, 0, 0, true, 0.0);
