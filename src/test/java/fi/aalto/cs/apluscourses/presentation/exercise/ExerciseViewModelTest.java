...
public class ExerciseViewModelTest {
  ...
  public void testIsSubmittable() {
    Exercise submittable = new Exercise(0, "", "http://abc.org", 0, 0, 0, true, 0.0);
    Exercise notSubmittable = new Exercise(0, "", "http://def.org", 0, 0, 0, false, 0.0);
  ...
  public void testGetStatusText() {
    Exercise exercise1 = new Exercise(0, "", "http://localhost:1212", 3, 49, 12, false, 0.0);
    ExerciseViewModel viewModel1 = new ExerciseViewModel(exercise1);
    Exercise exercise2 = new Exercise(0, "", "http://localhost:2121", 0, 0, 0, false, 0.0);
    ExerciseViewModel viewModel2 = new ExerciseViewModel(exercise2);
    Exercise exercise3 = new Exercise(0, "Feedback", "http://localhost:9999", 0, 0, 0, true, 0.0);
  ...
  public void testGetSearchableString() {
    ...
    Exercise exercise1 = new Exercise(0, name, "http://abc.org", 0, 0, 0, true, 0.0);
    ExerciseViewModel viewModel1 = new ExerciseViewModel(exercise1);
    Exercise exercise2 = new Exercise(0, "", "http://abc2.org", 0, 0, 0, false, 0.0);
    ExerciseViewModel viewModel2 = new ExerciseViewModel(exercise2);
